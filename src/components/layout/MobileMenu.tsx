        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-80 max-w-[85vw] bg-background/95 backdrop-blur-md border-l border-cyan-500/30 shadow-2xl z-50 md:hidden overflow-y-auto"
            >
              {/* サイバーグロー効果 */}
